                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    ...
                    <div class="relative" x-data="{ open: false }">
                        <button @click="open = !open" 
                                class="inline-flex items-center px-1 pt-1 border-b-2 {{ request()->routeIs('notices.*') ? 'border-gray-900 text-gray-900' : 'border-transparent text-gray-700 hover:text-gray-900' }} text-sm font-medium">
                            Notices
                        ...
                        <div x-show="open" 
                            ...
                            <a href="{{ route('notices.noticeboard') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Notice Board</a>
                            <a href="{{ route('notices.index') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">All Notices</a>
                            @can('create', \App\Models\Notice::class)
                            <a href="{{ route('notices.create') }}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">Post Notice</a>
                            @endcan
                        </div>
                    </div>
                    @endif
